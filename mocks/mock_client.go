...
func (m *MockClientProvider) Reader(ctx context.Context, topicConfig zstreams.ConsumerTopicConfig, opts ...zstreams.ReaderOption) (zstreams.Reader, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientProvider) Writer(ctx context.Context, topicConfig zstreams.ProducerTopicConfig, opts ...zstreams.WriterOption) (zstreams.Writer, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, topicConfig}
	for _, a := range opts {
		varargs = append(varargs, a)
