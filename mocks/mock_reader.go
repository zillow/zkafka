...
func (m *MockReader) Assignments(arg0 context.Context) ([]zstreams.Assignment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Assignments", arg0)
	ret0, _ := ret[0].([]zstreams.Assignment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Assignments indicates an expected call of Assignments.
func (mr *MockReaderMockRecorder) Assignments(arg0 interface{}) *gomock.Call {
...
func (m *MockReader) Read(ctx context.Context) (*zstreams.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Read", ctx)
	ret0, _ := ret[0].(*zstreams.Message)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
